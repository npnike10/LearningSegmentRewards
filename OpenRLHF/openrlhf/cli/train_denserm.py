...
from openrlhf.models import get_llm_for_sequence_regression_denserm, Actor
from openrlhf.trainer.denserm_trainer import RewardModelTrainer
...
def train(args):
    ...
    model = get_llm_for_sequence_regression_denserm(
        args.pretrain,
        "reward",
    ...
    train_dataset = PreferenceDataset(
        train_data, tokenizer, args.max_len, args.max_prompt_len, strategy, model_type=args.model_type
    )
    ...
    eval_dataset = PreferenceDataset(
        eval_data, tokenizer, args.max_len, args.max_prompt_len, strategy, model_type=args.model_type
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="Use segment credit entropy regularization in loss",
    )
    parser.add_argument("--lambda_reg", type=float, default=0.1, help="entropy regularization coefficient")
    ...
    parser.add_argument("--eval_split", type=str, default="train", help="val split of the dataset")
    ...
    elif "qwen3-sft-rat2" in args.pretrain.lower():
        model_type = "./checkpoint/qwen3-4B-sft-rat2"
    else:
        model_type = "debug"
