...
def retry(model_name_or_path, retries=3, delay=30):
    ...
    print(f"Absolute model path: {os.path.abspath(model_name_or_path)}")
...
# Construct transformer with a value head for sequence classification.
# https://github.com/huggingface/transformers/blob/405b56269812056d9593869e22b7b264d806cb1e/src/transformers/models/llama/modeling_llama.py#L1254
def get_llm_for_sequence_regression_denserm(
    model_name_or_path: str,
    model_type: str,
    *,
    bf16=True,
    ...
    **kwargs,
    ...
    base_pretrained_class = base_class.__base__
    if model_type == "reward":
        cls_class = _get_reward_model_denserm(
            base_pretrained_class, base_class, value_head_prefix, packing_samples, reward_mean, reward_std
        )
    else:
        cls_class = _get_critic_model_denserm(base_pretrained_class, base_class, value_head_prefix, packing_samples)
