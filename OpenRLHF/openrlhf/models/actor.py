...
import time
from .ring_attn_utils import gather_and_pad_tensor, unpad_and_slice_tensor, convert_ring_attn_params
from .utils import compute_entropy, log_probs_from_logits, reset_position_ids, log_probs_from_logits_denserm
...
class Actor_DenseRM(nn.Module):
    """
    Base class for Actor models in reinforcement learning with dense RM.
    ...
    def generate(self, input_ids: torch.Tensor, **kwargs) -> Union[
        ...
        if tokenizer.chat_template:
            ...
            elif self.strategy.args.model_type == "qwen3":
                generate_args["eos_token_id"] = [151645]
    ...
    def forward(
        ...
        log_probs = log_probs_from_logits_denserm(output["logits"][:, :-1, :], sequences[:, 1:])
