...
from openrlhf.models.denserm_loss import GPTLMLoss, PolicyLoss, ValueLoss
...
from .ppo_utils import (
    ...
    FixedKLController,
    NaiveReplayBufferDenseRM,
)
from .ppo_utils.denserm_experience_maker import Experience, NaiveExperienceMaker
...
class PPOTrainer(ABC):
    ...
    Args:
        ...
        actor (Actor_DenseRM): The actor model in the PPO algorithm.
        ...
        initial_model (Actor_DenseRM): The initial model for reference logits to limit actor updates in RLHF.
        ema_model (Actor_DenseRM): The exponential moving average model for stable training.
    ...
    def __init__(
        ...
        reward_fit_dataset: str = "rationales",
        **generate_kwargs,
    ) -> None:
        assert (
        ...
        self.replay_buffer = NaiveReplayBufferDenseRM(
    ...
    def fit(
        ...
        self.strategy.print(
            "steps: {}, start_episode: {}, consumed_samples: {}".format(steps, start_episode, consumed_samples)
        )
        ...
        for episode in range(start_episode, args.num_episodes):
            ...
            for rand_prompts in self.prompts_dataloader:
                ...
                self.strategy.print(
                    f"In generate experience function, global step: {steps}, experience.sequences: {experience.sequences.shape}"
                )
    ...
    def save_logs_and_checkpoints(self, args, global_step, step_bar, logs_dict={}, client_states={}):
        ...
        if global_step % args.save_steps == 0:
            ...
            self.strategy.save_model(
                self.actor.model, self.tokenizer, os.path.join(args.save_path, f"checkpoint-{global_step}")
            )
